 ...
 */
class Announce extends \GestionLpiBundle\Entity\Announce implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GestionLpiBundle\\Entity\\Announce' . "\0" . 'id', '' . "\0" . 'GestionLpiBundle\\Entity\\Announce' . "\0" . 'titre', '' . "\0" . 'GestionLpiBundle\\Entity\\Announce' . "\0" . 'announceText', '' . "\0" . 'GestionLpiBundle\\Entity\\Announce' . "\0" . 'dateCreation', '' . "\0" . 'GestionLpiBundle\\Entity\\Announce' . "\0" . 'dateModification', '' . "\0" . 'GestionLpiBundle\\Entity\\Announce' . "\0" . 'compte');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Announce $proxy) {
    ...
    public function setAnnounceText($announceText)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAnnounceText', array($announceText));

        return parent::setAnnounceText($announceText);
    }
    ...
    public function getAnnounceText()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAnnounceText', array());

        return parent::getAnnounceText();
    }
