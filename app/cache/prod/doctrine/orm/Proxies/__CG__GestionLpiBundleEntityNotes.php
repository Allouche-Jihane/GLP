 ...
 */
class Notes extends \GestionLpiBundle\Entity\Notes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GestionLpiBundle\\Entity\\Notes' . "\0" . 'id', '' . "\0" . 'GestionLpiBundle\\Entity\\Notes' . "\0" . 'note', '' . "\0" . 'GestionLpiBundle\\Entity\\Notes' . "\0" . 'description', '' . "\0" . 'GestionLpiBundle\\Entity\\Notes' . "\0" . 'matiere', '' . "\0" . 'GestionLpiBundle\\Entity\\Notes' . "\0" . 'etudiant');
        }
