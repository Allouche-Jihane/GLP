...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'datatable' => 'getDatatableService',
            'datatable.listener' => 'getDatatable_ListenerService',
            'datatable.twig.extension' => 'getDatatable_Twig_ExtensionService',
            ...
            'security.user.provider.concrete.our_database_comptes' => 'getSecurity_User_Provider_Concrete_OurDatabaseComptesService',
    ...
    /**
     * Gets the 'datatable' service.
     *
     * @return \Ali\DatatableBundle\Util\Datatable A Ali\DatatableBundle\Util\Datatable instance
     */
    protected function getDatatableService()
    {
        $instance = new \Ali\DatatableBundle\Util\Datatable($this);
    ...
    /**
     * Gets the 'datatable.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ali\DatatableBundle\EventListener\DatatableListener A Ali\DatatableBundle\EventListener\DatatableListener instance
     */
    protected function getDatatable_ListenerService()
    {
        return $this->services['datatable.listener'] = new \Ali\DatatableBundle\EventListener\DatatableListener($this->get('twig'));
    }

    /**
     * Gets the 'datatable.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ali\DatatableBundle\Twig\Extension\AliDatatableExtension A Ali\DatatableBundle\Twig\Extension\AliDatatableExtension instance
     */
    protected function getDatatable_Twig_ExtensionService()
    {
        return $this->services['datatable.twig.extension'] = new \Ali\DatatableBundle\Twig\Extension\AliDatatableExtension($this);
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'datatable.listener', 1 => 'onKernelResponse'), 255);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'GLPI', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\GestionLpiBundle\\Entity'))), 'GestionLpiBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('GestionLpiBundle' => 'GestionLpiBundle\\Entity'));
        ...
        $b->addCustomDatetimeFunction('utc_timestamp', 'DoctrineExtensions\\Query\\Mysql\\UtcTimestamp');
        $b->addCustomDatetimeFunction('extract', 'DoctrineExtensions\\Query\\Mysql\\Extract');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5161d6d661767ec59b9430f7b496369e59a9de8397448c1d82257f1baa1a9c31');
    ...
    protected function getIvoryCkEditor_ConfigManagerService()
    {
        ...
        $instance->setConfig('base_config', array('toolbar' => array(0 => array('name' => 'styles', 'items' => array(0 => 'Bold', 1 => 'Italic', 2 => 'BulletedList', 3 => 'Link')))));
    ...
    {
        $this->services['ivory_ck_editor.form.type'] = $instance = new \Ivory\CKEditorBundle\Form\Type\CKEditorType($this->get('ivory_ck_editor.config_manager'), $this->get('ivory_ck_editor.plugin_manager'), $this->get('ivory_ck_editor.styles_set_manager'), $this->get('ivory_ck_editor.template_manager'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('GestionLpiBundle\\Entity\\Compte' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/GestionCompte');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/GestionEtudiant');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/home');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajouterCompte');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/announce');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/gestionAbsence');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/gestionNotes');
        ...
        $q = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $p, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($p, 'gestion_lpi_home'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
        ...
        $r->setOptions(array('login_path' => 'gestion_lpi_homepage', 'always_use_default_target_path' => true, 'default_target_path' => '/announce', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $s->setOptions(array('login_path' => 'gestion_lpi_homepage', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($o, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.our_database_comptes')), 'secured_area', $a, $c), 2 => $q, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $p, 'secured_area', $r, $s, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5cfe611d222c26.59442202', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $o, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $p, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $p, 'gestion_lpi_homepage', false), NULL, NULL, $a, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('your_gmail_username');
        $a->setPassword('your_gmail_password');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \CMEN\GoogleChartsBundle\Twig\GoogleChartsExtension('current', 'fr'));
        $instance->addExtension($this->get('datatable.twig.extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GestionLpiBundle/Resources/views'), 'GestionLpi');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\egeloen\\ckeditor-bundle/Resources/views'), 'IvoryCKEditor');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\ali\\datatable\\Ali\\DatatableBundle/Resources/views'), 'AliDatatable');
    ...
    /**
     * Gets the 'security.user.provider.concrete.our_database_comptes' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_OurDatabaseComptesService()
    {
        return $this->services['security.user.provider.concrete.our_database_comptes'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'GestionLpiBundle:Compte', 'login', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GestionLpiBundle' => 'GestionLpiBundle\\GestionLpiBundle',
                ...
                'AliDatatableBundle' => 'Ali\\DatatableBundle\\AliDatatableBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'GestionLpiBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\GestionLpiBundle'),
                    'namespace' => 'GestionLpiBundle',
                ),
                ...
                'AliDatatableBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\ali\\datatable\\Ali\\DatatableBundle'),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'your_gmail_username',
            'swiftmailer.mailer.default.transport.smtp.password' => 'your_gmail_password',
